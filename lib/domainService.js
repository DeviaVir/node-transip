...
(function(domainService) {
   ...
   * @return {Promise}             
   */
  domainService.batchCheckAvailability = function batchCheckAvailability(transipInstance, domainNames) {
    ...
    var domains = [];
    return transipInstance.communicate(domainService.service, 'batchCheckAvailability', [data.domainNames], data).then(function(body) {
