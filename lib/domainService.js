 ...
 * @return {Promise}          
 */
domainService.prototype.retryCurrentDomainActionWithNewData = function retryCurrentDomainActionWithNewData(domain) {
  if(domain === void 0 || domain === '') {
    return Promise.reject(new Error(404));
  }
  ...
  return this.transip.communicate(this.service, 'retryCurrentDomainActionWithNewData', [data.domain], data).then(function(body) {
    if(body.length === void 0) {
      return Promise.reject(body);
    }

    return Promise.promisify(parseString)(body[1]).then(function(result) {
      if(result['SOAP-ENV:Envelope']['SOAP-ENV:Body'][0]['ns1:retryCurrentDomainActionWithNewDataResponse'] !== void 0) {
        return true;
      }
    });
  });
 ...
 * @return {Promise}          
 */
domainService.prototype.retryTransferWithDifferentAuthCode = function retryTransferWithDifferentAuthCode(domain, newAuthCode) {
  if(domain === void 0 || domain === '') {
    return Promise.reject(new Error(404));
  }

  if(newAuthCode === void 0 || newAuthCode === '') {
    return Promise.reject(new Error(405));
  }
  ...
  return this.transip.communicate(this.service, 'retryTransferWithDifferentAuthCode', [data.domain, data.newAuthCode], data).then(function(body) {
    if(body.length === void 0) {
      return Promise.reject(body);
    }

    return Promise.promisify(parseString)(body[1]).then(function(result) {
      if(result['SOAP-ENV:Envelope']['SOAP-ENV:Body'][0]['ns1:retryTransferWithDifferentAuthCodeResponse'] !== void 0) {
        return true;
      }
    });
  });
 ...
 * @return {Promise}          
 */
domainService.prototype.cancelDomainAction = function cancelDomainAction(domain) {
  if(domain === void 0 || domain === '') {
    return Promise.reject(new Error(404));
  }
  ...
  return this.transip.communicate(this.service, 'cancelDomainAction', [data.domain], data).then(function(body) {
    if(body.length === void 0) {
      return Promise.reject(body);
    }

    return Promise.promisify(parseString)(body[1]).then(function(result) {
      if(result['SOAP-ENV:Envelope']['SOAP-ENV:Body'][0]['ns1:cancelDomainActionResponse'] !== void 0) {
        return true;
      }
    });
  });
